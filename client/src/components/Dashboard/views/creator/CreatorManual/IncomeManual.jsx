    ...
    <GridContainer>
      <Card>
        <CardHeader color="blueGray" stats>
                ...
                <p className={classes.cardCategoryWhite}>방송송출 프로글매에 고유 URL을 붙여넣기해서 광고를 송출하면 자동적으로 수익금이 쌓입니다.</p>
        </CardHeader>
        ...
        <Stepper orientation="vertical">
          <Step active="true">
            <StepLabel>
              자신의 <strong>대시보드</strong>로 이동합니다.
            </StepLabel>
            <StepContent>
              <a>
          ...
          <Step active="true">
            <StepLabel>
              광고가 매칭된 상태에서 방송하게 되면 대시보드의 <strong>수익금</strong>에서 <br/>
