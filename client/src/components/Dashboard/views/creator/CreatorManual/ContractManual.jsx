    ...
    <GridContainer>
      ...
      <CardHeader color="blueGray" stats>
        ...
        <Stepper orientation="vertical">
          ...
          <Step active="true">
            <StepLabel>
            계정 관리에 있는 서비스 이용 및 출금 계약하기의 <br/>
            <strong>서비스 이용약관</strong>과 <strong>개인 정보 수집 및 동의</strong> 약관보기를 클릭합니다. <br/>
            <b>+</b>내용을 읽고 <strong>모두 동의</strong>를 클릭합니다.
            </StepLabel>
            <StepContent>
              <img src={broadCastingIcon} class={StepperClasses.img}/>
            </StepContent>
          ...
          <Step active="true">
            <StepLabel>
            모두 동의가 되면 체크박스가 2개 생겨요. <br/>
            마지막으로 <strong>확인</strong>버튼을 클릭해 주세요.
            </StepLabel>
            <StepContent>
              <img src={broadCastingIcon} class={StepperClasses.img}/>
            </StepContent>
          ...
          <Step active="true">
            <StepLabel>
            완료된 계약서는 계정관리 -> 크리에이터님의 정보란의 <br/>
            <strong>계약완료</strong>를 눌러 확인 가능합니다.
            </StepLabel>
            <StepContent>
              <img src={broadCastingIcon} class={StepperClasses.img}/>
            </StepContent>
          ...
          <Step active="true">
            <StepLabel>
            OnAD 플랫폼과 크리에이터님의 이용계약이 완료되었습니다. <br/>
