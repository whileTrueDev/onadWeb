...
//
import CreatorDashboard from '../../../layouts/CreatorDashboardLayout'
      ...
      <Card>
        <CardHeader color="blueGray" stats>
                ...
                <p className={classes.cardCategoryWhite}>
                  어떤 방송프로그램을 사용하시나요? OnAD는 XSplit Broadcaster와 OBS Studio를 지원합니다.<br/>
        ...
        <Stepper orientation="vertical">
          <Step active="true">
            ...
            <StepContent>
              <a>
                <img src={broadCastingIcon} class={StepperClasses.img}/>
              </a>
            </StepContent>
          </Step>
          <Step active="true">
            <StepLabel>
              하단에 있는 <strong>추가</strong>를 누른 후, <strong>Webpage</strong>를 클릭합니다.<br/>
              (참고 : XSplit 2.9 이하의 버전에서는 기타(Others) - Webpage에 있습니다.<br/>
          ...
          <Step active="true">
            <StepLabel>
              복사해둔 Url을 <strong>Ctrl + V</strong>를 눌러 붙여넣고, <strong>OK</strong>를 클릭합니다.
            </StepLabel>
            <StepContent>
              <img src={broadCastingIcon} class={StepperClasses.img}/>
            </StepContent>
          ...
          <Step active="true">
            <StepLabel>
              <p>를 <strong>오른쪽 마우스로 클릭</strong>합니다.</p>
              <p>환경설정 창이 뜨면 아래에 있는 <strong>메모리 소스 유지</strong>를 체크합니다.</p>
              <p>해상도를 설정해 두면 크기를 줄여도 비율이 그대로 유지됩니다.<br/>
              해상도를 설정해 두려면 <strong>커스텀 선택 후 800 x 480으로 지정</strong> 하세요. <br/>
              (적당히 조절해 가며 원하는 숫자로 입력하면 됩니다.) <br/>
        ...
        <Stepper orientation="vertical">
          ...
          <Step active="true">
            <StepLabel>
              하단에 있는 <strong>소스 목록</strong>에서 <strong>+</strong>를 누른 후, <strong>BrowserSource</strong>를 클릭합니다.<br/>
          ...
          <Step active="true">
            <StepLabel>
              새로 만들기를 클릭하여 <strong>확인</strong>을 클릭합니다. <br/>
