...
const AccountNumberForm = (props) => {
  ...
  return (
    <form id="accountForm" onSubmit={handleSubmit}>
      ...
      <DialogActions>
        <Button type="submit" value="Submit" className={!handleClose && 'MuiButtonBase-root MuiButton-root RegularButton-button-133 RegularButton-primary-136 MuiButton-text'}>
          등록
        </Button>
        {handleClose
        && (
