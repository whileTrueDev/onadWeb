...
//   const {
//     bannerList, dispatch, state, detailOpen, setDetailOpen, step1State
//   } = props;
...
//           <Grid item>
//             <StyledItemText primary="셋째,&nbsp;&nbsp; 캠페인 이름 입력하기" secondary="해당 광고 캠페인의 이름을 입력하세요." className={classes.label} />
//           </Grid>
//           <Grid item>
...
//         <Grid container direction="column" className={classes.item} spacing={1}>
//           <Grid item>
//             <StyledItemText primary="넷째,&nbsp;&nbsp; 배너 선택하기" secondary="해당 광고 캠페인에 사용할 배너를 선택해주세요." className={classes.label} />
...
//         </Grid>
//       </Grid>
//       {step1State.option === 'option1' || step1State.option === 'option2'
//         ? (<LandingUrlInput />) : (<div />)}
//       <Grid>
//         <BudgetInput
//           state={state}
