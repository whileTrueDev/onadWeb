const sendTypeConfig = [
  {
    title: '방송인 우선형이란?',
    text: `  
    - 내가 선호하는 특정 방송인에게 우선적으로 광고를 송출합니다.
    - 광고를 넣고 싶은 방송인을 직접 선택할 수 있습니다.`
  },
  {
    title: '특정게임 선택형이란?',
    text: `  
    - 선택한 게임을 방송하는 방송인에게 광고를 송출합니다.
    - 특정게임관련한 광고를 송출할 수 있습니다.`
  },
  {
    title: '노출 우선형이란?',
    text: `  
    - 시청자 수가 많은 방송인에게 우선적으로 광고 송출합니다.
...
const optionConfig = [
  ...
  },
  {
    title: '클릭 광고 옵션은?',
    text: `  
    - ONAD와 계약된 모든 방송인의 랜딩페이지에 광고가 게시됩니다.
...
const reportConfig = [
  ...
  },
  {
    title: 'CPC?',
    text: `
    CPC는 방송인들의 채널에서 클릭이 가능한 광고를 뜻합니다.
    - 배너 클릭 수 : 방송인의 채널에서 해당 광고를 클릭하여 정보를 조회한 횟수
    - 홈페이지 방문 수 : 방송인의 채널에서 해당 광고를 클릭한 후, 홈페이지까지 이동한 수
    `
  },
];
