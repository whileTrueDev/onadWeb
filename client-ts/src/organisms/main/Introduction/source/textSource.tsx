const textSource: any = {
  ...
  answerMarketer: [
    ...
    `,
    '현재 온애드와 계약된 크리에이터는 홈페이지 상단의 [크리에이터 리스트]로 접속하시면 바로 확인하실 수 있습니다!',
    ...
    `,
    '가능합니다! 광고 캠페인 생성 시 광고 송출 유형을 선택하실 수 있습니다. 마음에 드는 크리에이터, 게임 등을 골라 광고를 진행해보세요. 😊 ',
    '아쉽지만 현재 트위치 플랫폼에서만 진행이 가능합니다. 다만 유튜브 플랫폼 서비스도 꾸준히 개발 중이니 조금만 기다려주세요! 🛠️',
  ],
  questionCreator: [
  ...
  answerCreator: [
    ...
    `온애드에서 크리에이터님과 함께 진행할 수 있는 광고는 크게 두 가지입니다.
    \n1) 배너 노출 광고
