...
import CustonButton from '../../../atoms/CustomButtons/Button';
      ...
      <DialogContent>
        <Grid container direction="column" className={classes.contents}>
          ...
          <Grid item>
            ...
            <Divider component="hr" orientation="horizontal" fullWidth />
          </Grid>
...
// RegistDialog.defaultProps = {
//   handleClose: () => {},
// };

RegistDialog.propTypes = {
