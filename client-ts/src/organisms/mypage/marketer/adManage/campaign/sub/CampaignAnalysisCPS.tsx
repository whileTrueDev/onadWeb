...
export default function CampaignAnalysisCPS({
  campaignId,
}: CampaignAnalysisCPSProps): JSX.Element {
  ...
  const reportData = useGetRequest<{ campaignId: string }, CpsAnalysisReportData>(
    '/marketer/campaign/analysis/cps', { campaignId }
  );
  ...
  const creatorsData = useGetRequest<{ campaignId: string }, CreatorDataCPSInterface[]>(
    '/marketer/campaign/analysis/cps/creators', { campaignId }
  );
              ...
              <div>
                    ...
                    <article className={classes.chartContainer}>
                      <div>
                        <ReportStackedBar
                          ...
                          labelArray={['클릭', '판매']}
                        />
                        <Typography align="center" variant="body1">일별 클릭,판매량</Typography>
                      </div>
                      ...
                      <div className={classes.chart}>
                          ...
                          data={{
                            ...
                            datasets: [{
                              ...
                              data: [
                                ...
                                (reportData.data.adchatClick || 0
                                  + reportData.data.adpanelClick || 0)
                              ],
                              backgroundColor: [
                        ...
                        />
                        <Typography align="center" variant="body1">판매 비율</Typography>
                      </div>
                    </article>
                  )}
                </article>
                ...
                <article className={classes.article}>
                  ...
                  <Typography variant="h4" className={classes.bold}>
                    ...
                    <Typography variant="body2" component="span">개</Typography>
                  </Typography>
                </article>
