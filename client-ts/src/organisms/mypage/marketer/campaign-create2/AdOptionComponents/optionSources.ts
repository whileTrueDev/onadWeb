    ...
    materials: [
      {
        name: '생방송 송출 배너',
        desc:
          '생방송 화면에 송출되는 배너로 실시간으로 집계되는 시청자수에 맞게 광고 비용이 정산됩니다.\n스트리머에 애정이 있는 시청자들은 배너에 대해 긍정적이며 관심을 갖는 경향이 있습니다.',
        images: [
      ...
      },
      {
        name: '클릭 배너',
        desc:
          '방송화면 아래, 방송인의 프로필에 비치되어 클릭 시, 랜딩페이지로 이동할 수 있는 배너입니다.',
        images: [
          {
            desc: '모바일 화면 | 방송인 프로필에 위치하며 클릭 시 랜딩페이지로 이동합니다.',
            src: '/pngs/dashboard/ad_desc/모바일하단배너.png',
          },
          {
            desc: 'PC 화면 | 영상 하단에 위치하며 클릭 시 랜딩페이지로 이동합니다.',
            src: '/pngs/dashboard/ad_desc/피시하단배너.png',
          },
        ],
        billingType: 'eCPC',
        lastDesc:
