...
const SignOutDialog = (props: SignOutDialogProps): JSX.Element => {
  const { handleOpen, open, marketerId, signOutFunc } = props;
    ...
    <Dialog onClose={handleOpen} open={open}>
      <Paper>
        <div className={classes.container}>
          <Typography>
            회원 탈퇴를 진행하시면, 광고 캐시를 포함한 유저 정보가 모두 삭제처리 됩니다.
          </Typography>
          <Typography>
            또한 해당 아이디 (
        ...
        <Alert severity="error">
          <Typography>
            이름, 비밀번호, 메일, 전화번호, 사업자 등록번호, 계좌정보, 사업자 등록증 이미지,
            개인식별자, 등록한 배너, 등록한 캠페인, 충전된 캐시
          </Typography>
        </Alert>
