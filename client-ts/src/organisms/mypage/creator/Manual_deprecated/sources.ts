    ...
    source: [
      {
        ...
        description: `${textStyling.LinkText(
          '<대시보드>',
          'main',
        )}로 이동하여 상단에 있는 서비스 이용 및 출금 계약하기의 ${textStyling.styledText(
          '약관보기',
        )}를 클릭합니다.  
      ...
      {
        image: null,
        description: `동의 이후, 체크표시 <img src='/pngs/dashboard/manual/new_creator/creator-contraction-02.png' style="width: 120px; height: 40px; vertical-align: middle"/>가 생성된 것을 확인하세요.진행을 위해 ${textStyling.styledText(
          '확인',
        )} 버튼을 클릭해 주세요.`,
      },
      {
        image: null,
        description: `계약 상태 및 계약서 확인은 ${textStyling.LinkText(
          '<내 계정>',
          'user',
        )} 방송인님의 정보란에서 확인 가능합니다.`,
      },
    ],
  },
  programSetting: {
    ...
    xsplit: [
      {
        ...
        description: `${textStyling.styledBlock(`권장사항: Chrome(75 버전 이상)을 기본 브라우저로 사용하셔야 광고가 올바르게 송출됩니다.</br>
          크롬 버전 확인은 크롬 오른쪽 상단에 있는 아이콘 클릭 ${textStyling.styledText(
            '도움말',
          )} > ${textStyling.styledText('Chrome 정보')}를 눌러 확인 가능합니다.`)}`,
      },
      {
        image: '/pngs/dashboard/manual/new_creator/creator-setBanner-01.png',
        description: `배너를 송출하기 위해 ${textStyling.LinkText(
          '<대시보드>',
          'main',
        )}에서 배너 오버레이 URL의 ${textStyling.styledText(
          '주소보기',
        )}를 누르고 ${textStyling.styledText('복사')}를 눌려주세요.`,
      },
      {
        image: '/pngs/dashboard/manual/new_creator/creator-setBanner-02.png',
        description: `XSplit Broadcaster를 실행시키 뒤,  
          하단에 있는 ${textStyling.styledText('추가')}를 누른 후, ${textStyling.styledText(
          'Webpage',
        )}를 클릭합니다. ${textStyling.styledBlock(
          '(참고 : XSplit 2.9 이하의 버전에서는 기타(Others) - Webpage에 있습니다.</br>XSplit 3.0 버전 이상을 사용하는 것을 권장합니다.)',
        )}`,
      },
      {
        image: '/pngs/dashboard/manual/new_creator/creator-setBanner-03.png',
        description: `복사해둔 오버레이 주소를 ${textStyling.styledText(
          'Ctrl + V',
        )}를 눌러 붙여넣고, ${textStyling.styledText('OK')}를 클릭합니다.`,
      },
      {
      ...
      },
      {
        ...
        description: `배너 소스를 우클릭합니다. 환경설정 창이 뜨면 ${textStyling.styledText(
          'HTML',
        )}을 클릭하고  
          1. 스크롤바 숨기기에 체크에 합니다.  
          2. 메모리 소스유지에 체크합니다.  
          3. 해상도를 ${textStyling.styledText(
            'custom',
          )} 선택 이후 < 320 X 160 >으로 지정하세요. 해상도를 설정 후 크기를 줄여도 비율은 유지됩니다.`,
      },
      {
      ...
      },
      {
        ...
        description: `${textStyling.styledBlock(
          '내 방송의 해상도 확인은 오른쪽 위를 클릭하여 확인할 수 있습니다.',
        )}`,
      },
      {
        image: null,
    ...
    obs: [
      {
        image: null,
        description: `${textStyling.styledBlock(
          `권장사항: Chrome(75 버전 이상)을 기본 브라우저로 사용하셔야 광고가 올바르게 송출됩니다.</br>크롬 버전 확인은 크롬 오른쪽 상단에 있는 아이콘 클릭 ${textStyling.styledText(
            '도움말',
          )} > ${textStyling.styledText('Chrome 정보')}를 눌러 확인 가능합니다.`,
        )}`,
      },
      ...
      },
      {
        ...
        description: `OBS Studio를 실행시키 뒤,  
          하단에 있는 소스목록에서 ${textStyling.styledText(
            '+',
          )}버튼을 누른 후, ${textStyling.styledText(
          '브라우저',
        )}(BrowserSource)를 클릭합니다.${textStyling.styledBlock(
          '(권장사항: OBS Studio 19 이상 사용을 권장합니다.)',
        )}`,
      },
      {
        image: '/pngs/dashboard/manual/new_creator/creator-setBanner-09.png',
        description: `${textStyling.styledText('새로 만들기')}를 클릭하여 ${textStyling.styledText(
          '확인',
        )}을 클릭합니다.  
      ...
      },
      {
        ...
        description: `속성창이 뜨면
          URL에 복사해둔 오버레이 주소를 ${textStyling.styledText(
            'Ctrl + V',
          )}를 눌러서 붙여 넣습니다.  
          내 방송에 해상도가 1920 X 1080(1080p) 이상이면 너비를 320, 높이로 160 설정해주시고  
          내 방송의 해상도가 1280 X 720(720p)이면 너비를 214, 높이를 107으로 설정해줍니다.${textStyling.styledBlock(
            `내 방송의 해상도 확인은 우측아래 ${textStyling.styledText(
              '설정',
            )}의 ${textStyling.styledText('비디오')} 탭에서 확인할 수 있습니다.`,
          )}
          `,
      },
      {
    ...
    source: [
      {
        ...
        송출되고 있는 광고의 정보는 ${textStyling.LinkText(
          '<대시보드>',
          'main',
        )}의 현재 송출중인 배너에서 확인할 수 있습니다.`,
      },
      {
  ...
  landing: {
    ...
    source: [
      ...
      },
      {
        ...
        description: `자신의 트위치 방송채널에서, 패널 편집을 ${textStyling.styledText(
          'ON',
        )}으로 바꾼 후,  
      ...
      },
      {
        ...
        ${textStyling.LinkText(
          '<내 클릭광고>',
          'ad-dashboard',
        )}에서 기본이미지를 다운로드 받아 업로드하세요.  
      ...
      },
      {
        ...
        온애드의 광고채팅봇 ${textStyling.styledText(
          'onadbot',
        )}은 주기적으로 현재 송출중인 배너광고에 대한 설명과 광고 링크를 채팅으로 자동홍보해줘요.   
        시청자가 ${textStyling.styledText(
          'onadbot',
        )}이 홍보한 링크를 클릭하면, 클릭에 대한 추가적인 광고 수익이 발생한답니다.
        `,
      },
      {
        image: '/pngs/dashboard/manual/new_creator/creator-landing-03.png',
        description: `${textStyling.LinkText('<대시보드>', 'landing')} 또는 ${textStyling.LinkText(
          '<내 클릭광고>',
          'ad-dashboard',
        )}에서 현황을 확인할 수 있습니다.  
        `,
    ...
    source: [
      {
        ...
        description: `${textStyling.LinkText(
          '<내 배너광고>',
          'banner',
        )}에서 지금까지 진행한 모든 배너광고와, 해당 배너광고의 정보, 
