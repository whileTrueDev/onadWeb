          ...
          {tableData
            ...
            .map(bannerData => (
              <TableRow hover key={shortid.generate()}>
                ...
                <TableCell className={classes.tableCell}>
                  <div className={innerClasses.flex}>
                    <Typography gutterBottom variant="h6" className={innerClasses.head}>
                      총 수익
                    </Typography>
                  </div>
                  <div className={innerClasses.flex}>
                  ...
                  <Hidden mdDown>
                    <Grid container direction="row" spacing={5} className={innerClasses.grid}>
                      <Grid item>
                        <div className={innerClasses.flex}>
                          <Typography gutterBottom variant="body1" className={innerClasses.head}>
                            배너광고 수익
                          </Typography>
                        </div>
                        <div className={innerClasses.flex}>
