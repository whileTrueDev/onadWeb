    ...
    <div>
      <Grid container direction="column" justify="center" alignItems="center" spacing={2} className={classes.wraper}>
        <Grid item className={classes.title}>
          대한민국 거주자의 경우 서비스 이용 관계 법령에 따라 본인 확인 및 온애드로 발생하는 소득에 대한 원천징수 및 원천징수 신고를 위해 신분증을 제출받습니다.
        </Grid>
        <Grid item>
          <img src="/pngs/settlement/idcard.png" alt="주민등록증샘플" className={classes.sampleImg} />
        </Grid>
        <Grid item>
