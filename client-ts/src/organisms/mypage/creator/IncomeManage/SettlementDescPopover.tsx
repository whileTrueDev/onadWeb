  ...
  return (
    ...
    >
      <div className={classes.tooltip}>
        ...
        <Typography variant="body2">수익금 출금을 위해서 꼭 필요한 절차로,</Typography>
        <Typography variant="body2">몇 가지 세금처리 관련 정보를</Typography>
        <Typography variant="body2">온애드에 제출하는 절차입니다.</Typography>
      </div>
    </Popover>
  );
}
