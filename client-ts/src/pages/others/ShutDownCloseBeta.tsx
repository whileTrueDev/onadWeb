  ...
  return (
    <Grid container className={classes.root}>
      <Grid item className={classes.container} xs={12}>
        ...
        <span>
          <strong>1차 클로즈베타 테스터분들은</strong> 아래의 링크를 통해
          <strong>설문</strong>을 진행하여 주세요.
        </span>
        <span>
          <strong>2차 클로즈베타를 참여할 의사가 있는 분들은</strong> 아래의{' '}
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <Button
            ...
            size="large"
            onClick={() => {
              window.open('https://forms.gle/BTXTpvEpQJWfgPDz5');
            }}
          >
            1 차 클로즈 베타 설문하기
          </Button>
          <Button
            ...
            size="large"
            onClick={() => {
              window.open('https://forms.gle/oktdRvutqneeKAWRA');
            }}
          >
            2 차 클로즈 베타 신청하기
          </Button>
