...
import {
  chargeReducer,
  VbankInterface,
} from '../../../components/mypage/marketer/myoffice/interface';
import sources from '../../../components/mypage/marketer/sources/sources';
import ChargeAgreement from '../../../components/mypage/marketer/myoffice/charge/chargeAgreement';
import ChargeAmount from '../../../components/mypage/marketer/myoffice/charge/chargeAmount';
import ChargeComplete from '../../../components/mypage/marketer/myoffice/charge/chargeComplete';
import ChargeSolution from '../../../components/mypage/marketer/myoffice/charge/chargeSolution';
...
function ChargePage(): JSX.Element {
  ...
  const setSteps = (_index: number): JSX.Element => {
    switch (_index) {
      case 0:
        return <ChargeAgreement setStepComplete={setStepComplete} />;
      case 1:
        return (
          <ChargeAmount
      ...
      case 3:
        return <ChargeComplete state={stepState} vbankInfo={vbankInfo} />;
      default:
        return <div />;
    }
  };
