...
import Inquiry from '../../../../mainpage/main/inquiry/inquiry';
  ...
  return (
    <div className={classes.container}>
      ...
      <Button
        ...
        variant="outlined"
        color="default"
        onClick={InquiryDialog.handleOpen}
      >
        배너가 없으신가요?
      </Button>
      ...
      {/* 배너 생성 가이드 다이얼로그 */}
      <CustomDialog
        open={Boolean(InquiryDialog.open)}
        onClose={InquiryDialog.handleClose}
        fullWidth
        maxWidth="md"
        buttons={
          <Button onClick={InquiryDialog.handleClose} variant="contained">
            취소
          </Button>
        }
      >
        <Inquiry confirmClose={InquiryDialog.handleClose} />
      </CustomDialog>
    </div>
  );
}
