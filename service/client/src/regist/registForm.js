...
class RegistForm extends React.Component {
  ...
  checkId = (event)=>{
    let idReg = /^[A-za-z]+[a-z0-9]{4,15}$/g;
    this.setState({
  ...
  checkEmail = (event) =>{
    let idReg = /^[a-z0-9]+[a-z0-9]{6,15}$/g;
    this.setState({
    ...
    return (
      ...
      <form autoComplete="off" onSubmit={this.handleSubmit}>
        ...
        <FormControl className={classes.textField} 
            ...
            style={{ width : 220 }}
        >
        <InputLabel shrink={true} htmlFor="phoneNumber">전화번호</InputLabel>
        <Input
        ...
        {this.props.userType ? 
          <FormControl className={classes.codeField}>
            <InputLabel shrink={true}>사업자등록번호</InputLabel>
            <Input
