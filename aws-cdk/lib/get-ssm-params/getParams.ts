...
export default function getSSMParams(scope: cdk.Construct) {
  ...
  // *****************************************************
  // Db configurations
  const DB_HOST = ssm.StringParameter.fromStringParameterAttributes(scope, 'DB_HOST', {
  ...
  const DB_PORT = ssm.StringParameter.fromSecureStringParameterAttributes(scope, 'DB_PORT', {
    parameterName: '/DB_PORT',
    version: 1,
  });
  const DB_USER = ssm.StringParameter.fromStringParameterAttributes(scope, 'DB_USER', {
    parameterName: '/DB_USER',
  });
  const DB_DATABASE = ssm.StringParameter.fromStringParameterAttributes(scope, 'DB_DATABASE', {
    parameterName: '/DB_DATABASE',
  });
  const DB_CHARSET = ssm.StringParameter.fromStringParameterAttributes(scope, 'DB_CHARSET', {
  ...
  const SESSION_STORE_DB_PORT = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/SESSION_STORE_DB_PORT',
      version: 1,
    },
  );
  const SESSION_STORE_DB_PASSWORD = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/SESSION_STORE_DB_PASSWORD',
      version: 1,
    },
  );
  ...
  const TWITCH_CLIENT_ID = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    '/TWITCH_CLIENT_ID',
    {
      parameterName: '/TWITCH_CLIENT_ID',
      version: 1,
    },
  );
  const TWITCH_CLIENT_SECRET = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/TWITCH_CLIENT_SECRET',
      version: 1,
    },
  );
  ...
  const NAVER_CLIENT_SECRET = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    'NAVER_CLIENT_SECRET',
    {
      parameterName: '/NAVER_CLIENT_SECRET',
      version: 1,
    },
  );
  ...
  const NAVER_CLOUD_ACCESS_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/NAVER_CLOUD_ACCESS_KEY',
      version: 1,
    },
  );
  ...
  const NAVER_CLOUD_SECRET_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/NAVER_CLOUD_SECRET_KEY',
      version: 1,
    },
  );

  // Iamport payment
  const IMP_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(scope, 'IMP_KEY', {
    parameterName: '/IMP_KEY',
    version: 1,
  });
  const IMP_SECRET = ssm.StringParameter.fromSecureStringParameterAttributes(scope, 'IMP_SECRET', {
  ...
  const S3_ACCESS_KEY_ID = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    'S3_ACCESS_KEY_ID',
    {
      parameterName: '/S3_ACCESS_KEY_ID',
      version: 1,
    },
  );
  const S3_ACCESS_KEY_SECRET = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/S3_ACCESS_KEY_SECRET',
      version: 1,
    },
  );
  ...
  const GOOGLE_MAP_API_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    'GOOGLE_MAP_API_KEY',
    {
      parameterName: '/GOOGLE_MAP_API_KEY',
      version: 1,
    },
  );

  // Onad User crypto cipher credentials
  const CIPHER_IV = ssm.StringParameter.fromSecureStringParameterAttributes(scope, 'CIPHER_IV', {
    parameterName: '/CIPHER_IV',
    version: 1,
  });
  const CIPHER_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(scope, 'CIPHER_KEY', {
    parameterName: '/CIPHER_KEY',
    version: 1,
  });
  ...
  const CRAWL_TWITCH_API_CLIENT_SECRET = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/CRAWL_TWITCH_API_CLIENT_SECRET',
      version: 1,
    },
  );
  const CRAWL_TWITCH_API_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/CRAWL_TWITCH_API_KEY',
      version: 1,
    },
  );
  const CRAWL_YOUTUBE_API_KEY = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/CRAWL_YOUTUBE_API_KEY',
      version: 1,
    },
  );
  ...
  const TWITCH_BOT_OAUTH_TOKEN = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    {
      parameterName: '/TWITCH_BOT_OAUTH_TOKEN',
      version: 2,
    },
  );
  ...
  const MAIL_ID = ssm.StringParameter.fromStringParameterAttributes(scope, 'MAIL_ID', {
    parameterName: '/MAIL_ID',
  });
  const MAIL_PASSWORD = ssm.StringParameter.fromSecureStringParameterAttributes(
    scope,
    'MAIL_PASSWORD',
    {
      parameterName: '/MAIL_PASSWORD',
      version: 1,
    },
  );
  ...
  const ADPICK_AFF_ID = ssm.StringParameter.fromSecureStringParameterAttributes(
    ...
    'ADPICK_AFF_ID',
    {
      parameterName: '/ADPICK_AFF_ID',
      version: 1,
    },
  );

  const ADPICK_MEM_ID = ssm.StringParameter.fromStringParameterAttributes(scope, 'ADPICK_MEM_ID', {
    parameterName: '/ADPICK_MEM_ID',
  });
